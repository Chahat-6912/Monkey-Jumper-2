...
function preload(){
  ...
  bgm = loadImage("vector.jpg")
  jumpSound = loadSound("jump.mp3")
  yw1 = loadImage("uw2.png")
  failing = loadImage("fail.png")
...
function setup() {
  ...
  yw = createSprite(300, 300, 10, 10)
  yw.addImage("cjhuhuh", yw1)
  yw.scale = 0.1

  fail = createSprite(300, 300, 10, 10)
  fail.addImage("sjpqywhq", failing)
  fail.scale = 0.9
